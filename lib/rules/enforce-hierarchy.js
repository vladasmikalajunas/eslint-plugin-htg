...
module.exports = {
    ...
    create: function (context) {
        const {resolveFullPath, resolve2, resolveFromFullPath, stripCwd, findCategory} = createUtils(context.getCwd(), context.settings.htg);
        ...
        return {
            ...
            ImportDeclaration: (node) => {
                const target = resolve2(node.source.value);
